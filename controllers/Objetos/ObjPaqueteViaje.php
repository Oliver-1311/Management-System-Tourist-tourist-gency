...
class ObjPaqueteViaje
{
    public static function MostrarPaquete_viaje($eq_imp,$opc){
        include_once('Base.php');
        $sql= "select pv.idviaje_paquete,pv.descrip, pv.fecha, pv.hora,  pt.descripcion,pv.estado  from viaje_paquete as pv inner join paquete_turistico pt on pv.idpaquete_turistico = pt.idpaquete_turistico where descrip like '%" .$eq_imp."%' order by 2;";
            ...
            case 0:
                while ($valores = mysqli_fetch_array($query)) {
                    $dto=$dto."<tr style='font-size:14px;color:black;'><td style='text-align:center'>".$cont."</td><td>"
                        .$valores[1]."</td><td style='text-align:center'>".$valores[2]."</td><td style='text-align:center'>".$valores[3]."</td><td style='text-align:center'>".$valores[4]."</td><td style='text-align:center'>".$valores[5]."</td><td class='td-actions'>
