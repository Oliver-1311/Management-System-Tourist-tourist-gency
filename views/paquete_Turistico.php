...
<head>
    ...
    <script src="JS_Scripts/paquete_Turistico.js"></script>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1 style='text-align:center;font-weight:bold;color:#091896;'>Gestión de Paquetes turísticos</h1>
            <!-- <ol class="breadcrumb">
        ...
        <section class="content container-fluid">
            ...
            <div class="row">
                <div class="col-md-5">
				  ...
				  font-size: 105%;'><b>Nueva Paquete Turistico</b></h3>
                        </div>
                        <div class="panel-body" style='background-color: #FFFAFA;'>
                            <form role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="cbEstadoPaquete">
                                        <option value=0>Activo</option>
                                        <option value=1>Desactivo</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label style='color:blue'>Tipo de Paquete</label>
                                    <select class="form-control" id="cbTipoPaquete">
                                        <option value=0>Tipo 1</option>
                                        <option value=1>Tipo 2</option>
                                    </select>
                                </div>
                                <button type="submit" class="btn btn-info" id='btCrear' accesskey="g"><u>G</u>uardar
                                </button>
			  ...
			  font-family: "Latin Modern Roman 10";font-size: 105%;'>
                                <b>Lista de Paquetes Turístico</b></h3></div>
                        <div class="panel-body" style='background-color: #FFFAFA;'>
                            <div class="form-group" style="text-align: left;">

                                <div class="col-xs-10">
                                    <label style='color:blue;'>Buscar:</label><input type="text" id='txmrcBuscar'
